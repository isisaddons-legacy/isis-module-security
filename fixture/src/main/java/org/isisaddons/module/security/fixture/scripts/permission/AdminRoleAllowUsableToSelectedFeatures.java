...
public class AdminRoleAllowUsableToSelectedFeatures extends FixtureScript {
    ...
    protected void execute(ExecutionContext executionContext) {
        ...
        executionContext.add(this, adminRole.addClass(ApplicationPermissionRule.ALLOW, ApplicationPermissionMode.USABLE, ExampleSecuredEntity.class.getPackage().getName(), ExampleSecuredEntity.class.getSimpleName()));
        executionContext.add(this, adminRole.addMember(ApplicationPermissionRule.ALLOW, ApplicationPermissionMode.USABLE, ExampleSecuredEntity.class.getPackage().getName(), ExampleSecuredEntity.class.getSimpleName(), "name"));
